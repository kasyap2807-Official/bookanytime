...
import {
  ...
  hasClass,
  removeClass
} from "./chunk-TNBXNAZD.js";
import {
  require_react_dom
} from "./chunk-3JNRWEOI.js";
import {
  _extends,
  require_jsx_runtime
...
var DropdownMenu2 = React60.forwardRef(({
  ...
  if (align) {
    if (typeof align === "object") {
      ...
      false ? (0, import_warning2.default)(keys.length === 1, "There should only be 1 breakpoint when passing an object to `align`") : void 0;
      if (keys.length) {
...
var FormControl = React73.forwardRef(({
  ...
  false ? (0, import_warning3.default)(controlId == null || !id, "`controlId` is ignored on `<FormControl>` when `id` is specified.") : void 0;
...
var FormLabel = React76.forwardRef(({
  ...
  false ? (0, import_warning4.default)(controlId == null || !htmlFor, "`controlId` is ignored on `<FormLabel>` when `htmlFor` is specified.") : void 0;
  htmlFor = htmlFor || controlId;
...
var ListGroupItem = React88.forwardRef(({
  ...
  false ? (0, import_warning5.default)(as || !(!action && props.href), "`action=false` and `href` should not be used together.") : void 0;
...
var ListGroup = React89.forwardRef((props, ref) => {
  ...
  false ? (0, import_warning6.default)(!(horizontal && variant === "flush"), '`variant="flush"` and `horizontal` should not be used together.') : void 0;
...
var OverlayTrigger = ({
  ...
  if (triggers.indexOf("hover") !== -1) {
    false ? (0, import_warning7.default)(triggers.length > 1, '[react-bootstrap] Specifying only the `"hover"` trigger limits the visibility of the overlay to just mouse users. Consider also including the `"focus"` trigger so that touch and keyboard only users can see the overlay as well.') : void 0;
...
var ToggleButtonGroup = React148.forwardRef((props, ref) => {
  ...
  !(type !== "radio" || !!name) ? false ? (0, import_invariant4.default)(false, 'A `name` is required to group the toggle buttons when the `type` is set to "radio"') : (0, import_invariant4.default)(false) : void 0;
