...
var timeoutsShape = false ? import_prop_types3.default.oneOfType([import_prop_types3.default.number, import_prop_types3.default.shape({
  enter: import_prop_types3.default.number,
  exit: import_prop_types3.default.number,
  appear: import_prop_types3.default.number
}).isRequired]) : null;
var classNamesShape = false ? import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.shape({
...
var CDropdownMenu = (0, import_react46.forwardRef)(function(_a, ref) {
  ...
  var _c = (0, import_react46.useContext)(CDropdownContext), alignment = _c.alignment, container = _c.container, dark = _c.dark, dropdownMenuRef = _c.dropdownMenuRef, popper = _c.popper, portal = _c.portal, visible = _c.visible;
  ...
  return import_react46.default.createElement(
    ...
    import_react46.default.createElement(Component, __assign({ className: classNames("dropdown-menu", {
      show: visible
    }, alignment && getAlignmentClassNames(alignment), className), ref: forkedRef, role: "menu" }, !popper && { "data-coreui-popper": "static" }, dark && { "data-coreui-theme": "dark" }, rest), Component === "ul" ? import_react46.default.Children.map(children, function(child, index) {
